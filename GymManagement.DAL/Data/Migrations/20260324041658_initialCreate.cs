        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Member_Email", "Email Like '_%@_%._%'");
                    table.CheckConstraint("CK_Member_Phone", "(Phone Like '010%' OR Phone Like '011%' OR Phone Like '012%' OR Phone Like '015%') AND Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Trainer_Email", "Email Like '_%@_%._%'");
                    table.CheckConstraint("CK_Trainer_Phone", "(Phone Like '010%' OR Phone Like '011%' OR Phone Like '012%' OR Phone Like '015%') AND Phone Not Like '%[^0-9]%'");
                });
